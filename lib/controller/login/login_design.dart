                ...
                child: Align(
                  ...
                  child: Row(
                    ...
                    children: [
                      Container(
                        height: 590,
                        child: Image.asset("assets/images/picdocinlogin.png"),
                      ),
                    ],
                  ),
                ),
                                  ...
                                  child: Form(
                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        BlocConsumer<xBoneLoginCubit,
                                            xBoneLoginState>(
                                          listener: (context, state) {
                                            if (state
                                                is xBoneLoginSuccessState) {
