...
class homePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    String formattedDate = currentDate.toString().substring(0, 10); // Extracting only the date part
                    ...
                    Container(
                      ...
                      child: TextFormField(
                        ...
                        decoration:   InputDecoration(
                          ...
                          label: Text('Search doctors or clinics',
                            style: TextStyle(
                              fontWeight: FontWeight.w400,
                              fontSize: 14,
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text("Orthopedics and joints specialist",
                                    style: TextStyle(
                                        fontSize: 8.0,
                            ...
                            child: TextButton(
                                child:Row(
                                  ...
                                  children: [
                                    ...
                                    Image.asset("assets/images/iconWatts.png",
                                      width: 12,
                                      height: 12,),
                                  ],
                                ) ,
          ...
          children: [
            ...
            Padding(
              padding: const EdgeInsets.only(top: 11.0,
                  left: 16),
              child: Text("How to stretch your hip\nin 5 min"
                ,style: TextStyle(
                  fontWeight:FontWeight.w600 ,
                  fontSize:15.0,
                  color: HexColor("#FFFFFF"),
